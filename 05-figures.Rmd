...
```
## Urban leaf-pollen
```{r, eval=TRUE, fig.width=8, fig.height=4, fig.cap=""}
p_doy_variation
```

## Urban pollen map
```{r, eval=TRUE, fig.width=8, fig.height=10, fig.cap=""}
p_plant_map_doy
```

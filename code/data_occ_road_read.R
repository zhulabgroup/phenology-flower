if (!file.exists(str_c(.path$intermediate, "tree/sf_road.rds"))) {
  ...
  write_rds(sf_road, str_c(.path$intermediate, "tree/sf_road.rds"))
} else {
  sf_road <- read_rds(str_c(.path$intermediate, "tree/sf_road.rds"))
}

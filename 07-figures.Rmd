...
## All cities and taxa
```{r, eval=TRUE, fig.width=8, fig.height=12, fig.cap="Matching remotely-sensed leafing phenology with ground-observed pollen phenology. Leafing phenology tuned to the best green-up/down thresholds and leafing-pollen lags are shown in blue lines. Pollen concentration (squareroot-transformed) are shown in red points. All data are normalized."}

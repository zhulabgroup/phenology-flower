...
required_packages <- c(
  "broom", "cowplot", "doSNOW", "foreach", "geosphere", "ggpubr", "ggrepel", "ggspatial", "ggthemes", "gtools", "imputeTS", "knitr", "lmerTest", "lubridate", "magick", "mclust", "parallel", "patchwork", "ptw", "rnpn", "scales", "sf", "taxize", "terra", "tidyverse"
)

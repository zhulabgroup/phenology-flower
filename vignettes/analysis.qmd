...
required_packages <- c("broom", "cowplot", "ggpubr", "ggrepel", "ggspatial", "ggthemes", "gtools", "imputeTS", "lubridate", "patchwork", "ptw", "scales", "sf", "terra", "tidyverse")

if (.full_data) {
  additional_packages <- c("doSNOW", "foreach", "geosphere", "mclust", "parallel", "rnpn", "taxize")
  required_packages <- c(required_packages, additional_packages)
}
